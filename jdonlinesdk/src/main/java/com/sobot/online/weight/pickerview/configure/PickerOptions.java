package com.sobot.online.weight.pickerview.configure;
...
import com.sobot.online.weight.pickerview.listener.CustomListener;
import com.sobot.online.weight.pickerview.listener.OnOptionsSelectChangeListener;
import com.sobot.online.weight.pickerview.listener.OnOptionsSelectListener;
import com.sobot.online.weight.pickerview.listener.OnTimeSelectChangeListener;
...
public class PickerOptions {
    ...
    //constant
    private static final int PICKER_VIEW_BTN_COLOR_NORMAL = 0xFF0DAEAF;
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.sobot_pickerview_options;
        } else {
            layoutRes = R.layout.sobot_pickerview_time;
        }
    }
