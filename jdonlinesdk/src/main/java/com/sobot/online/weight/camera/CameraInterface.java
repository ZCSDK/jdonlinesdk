...
import com.sobot.online.weight.camera.util.AngleUtil;
import com.sobot.online.weight.camera.util.CameraParamUtil;
import com.sobot.online.weight.camera.util.CheckPermission;
import com.sobot.online.weight.camera.util.DeviceUtil;
...
//        }
        ...
        if (saveVideoPath.equals("")) {
            saveVideoPath = SobotOnlineUtils.getSDCardRootPath(mContext);
        }
