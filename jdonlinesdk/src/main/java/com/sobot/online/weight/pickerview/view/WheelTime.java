package com.sobot.online.weight.pickerview.view;

import android.view.View;

import com.sobot.online.R;
import com.sobot.online.weight.contrarywind.listener.OnItemSelectedListener;
import com.sobot.online.weight.contrarywind.view.WheelView;
import com.sobot.online.weight.pickerview.adapter.ArrayWheelAdapter;
import com.sobot.online.weight.pickerview.adapter.NumericWheelAdapter;
import com.sobot.online.weight.pickerview.listener.ISelectTimeCallback;
import com.sobot.online.weight.pickerview.utils.ChinaDate;
import com.sobot.online.weight.pickerview.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        //wv_hours.setLabel(context.getResources().getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (WheelView) view.findViewById(R.id.min);
        wv_minutes.setAdapter(new NumericWheelAdapter(0, 59));
        //wv_minutes.setLabel(context.getResources().getString(R.string.pickerview_minutes));// 添加文字
        ...
        //wv_seconds.setLabel(context.getResources().getString(R.string.pickerview_minutes));// 添加文字
