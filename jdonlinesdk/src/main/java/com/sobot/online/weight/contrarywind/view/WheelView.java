package com.sobot.online.weight.contrarywind.view;
...
import com.sobot.online.weight.contrarywind.adapter.WheelAdapter;
import com.sobot.online.weight.contrarywind.interfaces.IPickerViewData;
import com.sobot.online.weight.contrarywind.listener.LoopViewGestureListener;
import com.sobot.online.weight.contrarywind.listener.OnItemSelectedListener;
import com.sobot.online.weight.contrarywind.timer.InertiaTimerTask;
import com.sobot.online.weight.contrarywind.timer.MessageHandler;
import com.sobot.online.weight.contrarywind.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SobotPickerview, 0, 0);
            mGravity = a.getInt(R.styleable.SobotPickerview_sobot_wheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.SobotPickerview_sobot_wheelview_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.SobotPickerview_sobot_wheelview_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.SobotPickerview_sobot_wheelview_dividerColor, 0xFFd5d5d5);
            dividerWidth = a.getDimensionPixelSize(R.styleable.SobotPickerview_sobot_wheelview_dividerWidth, 2);
            textSize = a.getDimensionPixelOffset(R.styleable.SobotPickerview_sobot_wheelview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.SobotPickerview_sobot_wheelview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
