...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private com.sobot.online.weight.pickerview.view.WheelTime wheelTime; //自定义控件
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(mPickerOptions.textContentConfirm) ? context.getResources().getString(R.string.online_ok) : mPickerOptions.textContentConfirm);
            btnCancel.setText(TextUtils.isEmpty(mPickerOptions.textContentCancel) ? context.getResources().getString(R.string.online_cancle) : mPickerOptions.textContentCancel);
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new com.sobot.online.weight.pickerview.view.WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
        if (mPickerOptions.timeSelectChangeListener != null) {
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                @Override
                public void onTimeSelectChanged() {
                    try {
                        Date date = com.sobot.online.weight.pickerview.view.WheelTime.dateFormat.parse(wheelTime.getTime());
