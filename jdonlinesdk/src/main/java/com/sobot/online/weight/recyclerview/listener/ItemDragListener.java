...
import com.sobot.online.weight.recyclerview.adapter.HelperRecyclerViewDragAdapter;
...
public class ItemDragListener extends ItemTouchHelper.Callback {
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        return type == SobotRecyclerView.TYPE_REFRESH_HEADER || type == SobotRecyclerView.TYPE_LOADMORE_FOOTER;
