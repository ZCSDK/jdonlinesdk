package com.sobot.online.weight.kpswitch.widget.adpater;
...
public class PlusAdapter<T> extends BaseAdapter {
    ...
    protected SobotChattingPanelUploadView.SobotPlusClickListener mOnItemClickListener;

    public PlusAdapter(Context context, PlusPageEntity pageEntity, SobotChattingPanelUploadView.SobotPlusClickListener onItemClickListener) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(context);
        this.mPlusPageEntity = pageEntity;
        this.mOnItemClickListener = onItemClickListener;
        this.mItemHeightMaxRatio = DEF_HEIGHTMAXTATIO;
        this.mDefalutItemHeight = this.mItemHeight = (int) context.getResources().getDimension(R.dimen.sobot_item_plus_size_default);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.sobot_chat_plus_menu_item, null);
            viewHolder.rootView = convertView;
            viewHolder.ly_root = (LinearLayout) convertView.findViewById(R.id.sobot_ly_root);
            viewHolder.mMenu = (TextView) convertView.findViewById(R.id.sobot_plus_menu);
