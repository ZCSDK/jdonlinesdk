 ...
 */
public class SobotSwipeMenuRecyclerView extends SobotRecyclerView {
    ...
    public SobotSwipeMenuRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SobotSwipeMenuRecyclerView(Context context, AttributeSet attrs, int defStyle) {
