...
import com.sobot.online.weight.kpswitch.handler.KPSwitchRootLayoutHandler;
...
public class KPSwitchConflictUtil {
    ...
    public static void showPanel(final View panelLayout) {
        ...
        if (!SobotWidgetApi.getSwitchMarkStatus(SobotMarkConfig.LANDSCAPE_SCREEN)) {//是竖屏
            if (activity.getCurrentFocus() != null) {
                KeyboardUtil.hideKeyboard(activity.getCurrentFocus());
            }
        } else {
            SobotOnlineLogUtils.e(panelLayout.getMeasuredHeight() + "");
//            if (panelLayout.getMeasuredHeight() > ScreenUtils.getScreenHeight(activity) * 0.6) {//
            ...
            layoutParams.height = (int) (SobotScreenUtils.getScreenHeight() * 0.37);
