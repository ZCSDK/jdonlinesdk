package com.sobot.online.weight.recyclerview.swipemenu;
...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public SwipeMenuLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SobotSwipeMenu, 0, defStyle);
            animDuration = a.getInteger(R.styleable.SobotSwipeMenu_anim_duration, 500);
            a.recycle();
        }
    }
    ...
    private void swipe(int dis) {
        ...
        if (mSwipeDirection == SobotSwipeMenuRecyclerView.DIRECTION_LEFT) {
