...
import com.sobot.online.weight.pickerview.listener.OnDismissListener;
import com.sobot.online.weight.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.sobot_layout_basepickerview, mPickerOptions.decorView, false);
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.sobot_custom_dialog2);
            mDialog.setCancelable(mPickerOptions.cancelable);//不能点外面取消,也不能点back取消
            mDialog.setContentView(dialogView);

            Window dialogWindow = mDialog.getWindow();
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(R.style.sobot_picker_view_scale_anim);
