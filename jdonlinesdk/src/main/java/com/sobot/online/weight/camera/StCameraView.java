...
import com.sobot.online.weight.camera.state.CameraMachine;
...
import com.sobot.online.weight.camera.view.StICameraView;
...
//                mFlashLamp.setVisibility(INVISIBLE);
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(getContext().getResources().getString(R.string.online_voice_time_short));
