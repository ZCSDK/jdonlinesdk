...
public class SobotViewPagerAdapter extends SmartFragmentStatePagerAdapter {
    private String[] tabs;
    ...
    public void finishUpdate(ViewGroup container) {
        try {
            ...
            Log.d(SobotViewPagerAdapter.class.getSimpleName(), "Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
        }
    }*/
