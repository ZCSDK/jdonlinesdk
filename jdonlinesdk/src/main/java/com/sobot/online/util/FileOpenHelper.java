...
public class FileOpenHelper {
    ...
    public static boolean checkEndsWithInStringArray(String checkItsEnd, Context context
        ...
        try {
            String[] fileEndings = context.getResources().getStringArray(SobotResourceUtils
    ...
    public static void openFileWithType(Context context, File file) {
        ...
        if (file != null && file.exists() && file.isFile()) {
            ...
            try {
                ...
                //ignor
                SobotToastUtil.showCustomToast(context,context.getResources().getString(R.string.sobot_cannot_open_file));
//                e.printStackTrace();
            }
        }
    }
