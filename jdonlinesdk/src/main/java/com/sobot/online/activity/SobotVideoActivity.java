...
import com.sobot.online.weight.camera.StVideoView;
...
public class SobotVideoActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoView.setVideoLisenter(new StVideoListener() {
            ...
            @Override
            public void onEnd() {
                SobotOnlineLogUtils.i("progress---onEnd");
    ...
    private void initData() {
        try {
            ...
            } else if (!TextUtils.isEmpty(mCacheFile.getUrl()) && !mCacheFile.getUrl().startsWith("http")) {
                showFinishUi(mCacheFile.getUrl());
            } else {
                restoreTask();
            }
        } catch (Exception e) {
